...
public class DBHelper {
    ...
    public static List<ZetaMap> execToZetaMaps(PreparedStatement ps) throws SQLException {
    ...
    public static List<ZetaMap> execToZetaMaps(Connection con, String sql, Object... parameters) throws SQLException {
    ...
    public static List<ZetaMap> execToZetaMaps(Connection con, String sql) throws SQLException {
     ...
     * @throws SQLException
     */
    public static int execUpdate(Connection con, String sql, Object... parameters) throws SQLException {
     ...
     * @throws SQLException
     */
    public static List<ZetaMap> execUpdateToZetaMaps(Connection con, String sql, String[] generatedKeys, Object... parameters) throws SQLException {
        logger.info("execUpdate: " + sql);
